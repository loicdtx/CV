...
\begin{entrylist}
  \entry
    ...
    {CONABIO, Mexico}
    {Development of an operational near-real time ocean monitoring and alert system, research, project management.\\}
  \entry
    {10/16 - Now}
    {Geo-Spatial consultant}
    {}
    {Systems and software development, research.\\}
  \entry
    {02/12 - 06/16}
    {PhD Researcher}
...
\section{Scientific work}
    ...
    \\
    \textbf{Dutrieux, L. P.}, Poorter, L., Equihua, J., Ascarrunz, N., Herold, M., Pe\~{n}a-Claros, M., Roerink, G., Toledo, M., Kooistra, L. (\textit{in review})\\
    \textbf{Country wide mapping of forest diversity and structure by combining forest inventories with remote sensing.}\\
    \\
    \textbf{Dutrieux, L. P.}, Kooistra, L., Herold, M., Poorter, L. (\textit{in prep})\\
